C Busca los picos en un corte de la imagen. Da igual si el corte ha sido
C en el eje X o en el eje Y (corregido o sin corregir de distorsion).
C N: dimension de XP,YP
C XP(N),YP(N): corte en el cual se va a buscar los picos
C N1,N2: region en la que se van a buscar los picos
C NPEAKS: numero de picos encontrados
C XPEAKS,YPEAKS: posicion de los picos y sen~al en los mismos
C
...
C------------------------------------------------------------------------------
C usamos el algoritmo de findmax.f (REDUCEME) para la primera estimacion
C de los picos
...
C------------------------------------------------------------------------------
        ...
        END DO
C------------------------------------------------------------------------------
C Ahora que ya tenemos una posicion inicial, la refinamos ajustado una
C parabola
        IF(NPEAKS.GT.0)THEN
          DO J=1,NPEAKS
