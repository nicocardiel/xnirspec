! Dados una serie de N puntos X(N), Y(N), esta subrutina realiza ajuste
! polinomicos de forma interactiva
...
!------------------------------------------------------------------------------
        LEXAMINE=.TRUE.
        DO WHILE(LEXAMINE)
          NDEG=READILIM('Polynomial degree (0=exit)','0',0,MIN0(19,N-1))
          IF(NDEG.EQ.0)THEN
            LEXAMINE=.FALSE.
          ELSE
            DO K=1,NDEG+1
...
!..............................................................................
! OLS(Y|X) sin pesos
            CALL FITPOL(N,X,Y,NDEG,IFCOEFF,COEFF,VARCOEFF,CHISQR,SR2,COVAR)
            WRITE(*,101) '=> OLS(Y|X):'
            ...
            END DO
            CALL SUBPLOTBIS(NXYMAX,1,NXYMAX,XP,YP,XP,YP,.FALSE.,.FALSE.,NDEG,101,1.0)
!..............................................................................
! OLS(Y|X) con bootstrap
            NSEED=-1
            IF(NCOEFF.LT.N)THEN
              DO NSIMUL=1,NSIMULMAX
                ...
                DO WHILE(NUSED.LT.NCOEFF)
                  ...
                  END DO
                END DO
                CALL FITPOL(N,XP,YP,NDEG,IFCOEFF,COEFF,VARCOEFF,CHISQR,SR2,COVAR)
                DO K=1,NDEG+1
              ...
              DO K=1,NDEG+1
                ...
                VARCOEFF(K)=0
                DO NSIMUL=1,NSIMULMAX
                  VARCOEFF(K)=VARCOEFF(K)+(COEFF_SIMU(K,NSIMUL)-COEFF(K))*(COEFF_SIMU(K,NSIMUL)-COEFF(K))
                END DO
            ...
            IF(NCOEFF.LT.N)THEN
              DO NSIMUL=1,N
                DO I=1,N
                  ...
                  END IF
                END DO
                CALL FITPOL(N-1,XP,YP,NDEG,IFCOEFF,COEFF,VARCOEFF,CHISQR,SR2,COVAR)
                DO K=1,NDEG+1
                  COEFF_SIMU(K,NSIMUL)=COEFF(K)
                END DO
              END DO
