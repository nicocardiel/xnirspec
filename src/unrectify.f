        ...
        IF(IRESAMPL.EQ.1)THEN
          DO I=I1,I2-1
            ...
            DO J=J1,J2-1
              ...
              IF(LERR)THEN
                IMAGEN(JJ,II,NEWBUFF+NMAXBUFF/2)=
     +           IMAGEN(J-J1+1,I-I1+1,NCBUFF+NMAXBUFF/2)
              END IF
            END DO
          ...
          DO J=J1,J2-1
            ...
            DO II=IYMIN,IYMAX
              DO JJ=IXMIN,IXMAX
                ...
                IMAGEN(JJ,II,NEWBUFF)=IMAGEN(JJ,II,NEWBUFF)+
     +           IMAGEN(J-J1+1,I-I1+1,NCBUFF)*FAREA/FAREATOT
...
C
        IF(LERR)THEN
          DO I=1,NAXIS(2,NEWBUFF+NMAXBUFF/2)
            DO J=1,NAXIS(1,NEWBUFF+NMAXBUFF/2)
              IMAGEN(J,I,NEWBUFF+NMAXBUFF/2)=
     +         SQRT(IMAGEN(J,I,NEWBUFF+NMAXBUFF/2))
            END DO
          END DO
        END IF
C------------------------------------------------------------------------------
