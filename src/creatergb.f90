...
!
        ...
        NBUFF_G=READILIM('Buffer # for GREEN (0=(red+blue)/2)',CDUMMY,0,NMAXBUFF)
...
!
        ...
        END IF
!------------------------------------------------------------------------------
! Abrimos fichero y escribimos cabecera
...
! escribimos imagen
            ...
            ELSE
              ...
              IF(CLOGRGB.EQ.'y')THEN
                IF(PIXELR.GT.BG)THEN
                  PIXELR=(ALOG10((PIXELR-BG)/(FG-BG))+FLOGRGB)/FLOGRGB*255.
                ELSE
                  PIXELR=0.
                END IF
                IF(PIXELG.GT.BG)THEN
                  PIXELG=(ALOG10((PIXELG-BG)/(FG-BG))+FLOGRGB)/FLOGRGB*255.
                ELSE
                  PIXELG=0.
                END IF
                IF(PIXELB.GT.BG)THEN
                  PIXELB=(ALOG10((PIXELB-BG)/(FG-BG))+FLOGRGB)/FLOGRGB*255.
                ELSE
                  PIXELB=0.
                END IF
              ELSE
        ...
        END DO
! en caso necesario, completamos ultima linea
