C Ordena las lineas espectrales que definen el boundary
C
...
C
        ...
        END IF
C------------------------------------------------------------------------------
C si tenemos intersecciones, calculamos limites
